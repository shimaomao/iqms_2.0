...
public class UserServiceImpl implements UserService, UserDetailsService
{
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException
    {
        ...
        // add by tianjm 2181107
        Date createdDate=(Date) user.get(User.CREATEDDATE);
        ...
        UserDetails userDetails = new CurrentUser(username, pwd, enabled, accountNonExpired, credentialsNonExpired,
                ...
                userPicSuffix, userPicData, age, birthday, about,createdDate);
	...
	//20181108 by tianjm
	public void lockUsersByUserId(int userId) {
		Map<String, Object> map = null;
		boolean locked = true;
...
//		map.put(Bean.LAST_UPDATED_BY, CurrentUserHolder.getCurrentUser().getUserId());
		...
		userMapper.lockUserAoto(map);
	}
	
	public void updateUserErrorTimes(int userId) {
		Map<String, Object> map = null;
...
//		map.put(Bean.LAST_UPDATED_BY, CurrentUserHolder.getCurrentUser().getUserId());
		...
		userMapper.updateUserErrorTimes(map);
	}
}

    ...
    function copyToOrg(){
    	if($("#orgDevicelist").val()!="" && $("#orgDevicelist").val()!=null){
    		var jc = $.confirm({
    	        ...
    	        theme:'bootstrap',
    	        content: '将清空'+deviceNo+'的客户识别配置，确定要应用吗?',
    	        draggable: true,
    	        closeIcon: true,
    	        offsetTop: 150,
    	        ...
    	        buttons:{
    	            ...
    	            ok: {
    	                ...
    	                action: function(){
    	                	...
    	                	var url = contextPath + "/businessconfig/fastcopycustrecognition?dt="+(new Date().getTime());
    ...
    function addTr(itemData)
    {
      ...
      } else
      {
        $tr = $("<tr>" +
				...
				"<td><div class=\"controls\"><input value='1'  maxlength='3' digits='true' required='true'  validate='{required:true,digits:true,range:[1,8]}' name='len" + index + "'  class=\"form-control\"  placeholder=\"请输入匹配长度\"></div></td>" +
				"<td><div class=\"controls\"><input value='1' maxlength='32' zm_sz2='true' required='true' validate='{required:true,num:true,maxlength:8}' name='matchingMin" + index + "'  class=\"form-control\"  placeholder=\"请输入匹配最小值\"></div></td>" +
				"<td><div class=\"controls\"><input value='1' maxlength='32' zm_sz2='true' required='true' validate='{required:true,num:true,maxlength:8}' name='matchingMax" + index + "'  class=\"form-control\"  placeholder=\"请输入匹配最大值\"></div></td>" +

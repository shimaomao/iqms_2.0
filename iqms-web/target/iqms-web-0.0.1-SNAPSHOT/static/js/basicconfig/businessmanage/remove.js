            ...
            ok: {
                ...
                action: function(){
        			...
        			for (var i = 0; i < selIds.length; i++){
        				...
        				//获取主键值
        				var businessId = rowData.businessId;
        				list.push(businessId);
        			}
        			//将删除数据提交到后台
        			 $.ajax({
        		                url : contextPath + "/basicconfig/businessmanage?_method=delete&dt="+(new Date().getTime()),
        		                type : "post",
        		                dataType : "json",

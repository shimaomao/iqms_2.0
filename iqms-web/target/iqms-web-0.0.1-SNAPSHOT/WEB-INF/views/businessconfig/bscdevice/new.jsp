...
<script src="${staticPath}/static/js/businessconfig/bscdevice/new.js"></script>
<!--模态窗口页面内容这里是一个表单-->
<div id="dialog-new" class="hide">
	<form name="FormPost"  class="form-horizontal" onsubmit="return false;" style="width:auto;height:auto;" id="qwer1234">
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
					<input type="text" id="deviceNo" name="deviceNo" readonly="readonly" placeholder="点击自动生成" onclick="fillDevNo()" class="col-md-9 col-sm-5" />
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
					<input type="text" id="hostName" name="hostName" placeholder="主机名称" class="col-md-9 col-sm-5" />
				</div>
			</div>
		</div>
		...
		<div class="space-4"></div>
		<div class="form-group">
			<label class="col-md-3 control-label no-padding-right" for="screenResolution"> 分辨率 </label>

			<div class="col-md-9">
				<div class="clearfix">
					<select  id="screenResolution" name="screenResolution" class="col-md-9 col-sm-5">
					</select>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
					<select  id="producer" name="producer" class="col-md-9 col-sm-5">
					</select>
				</div>
			</div>
		</div>

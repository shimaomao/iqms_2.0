...
<body>
		...
		<div class="navbar-container" id="navbar-container">
			<div class="navbar-header pull-left">
				<a href="#" class="navbar-brand">
					<small>
						<i class="icon-leaf"></i>
						<!--<fmt:message key="index.application" />-->智能分流与营销系统&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="main-container" id="main-container">
		...
		<div class="main-container-inner">
			...
			<!--  
			iframe高度：<span id="iframeheight"></span>   整个页面高度：<span id="docheight"></span>
			-->
				...
				<iframe id="mainframe" name="mainframe" style="width:100%;height:500px;border:0px" ></iframe>
				 scrolling="no"
				 -->
				<iframe id="mainframe" name="mainframe" style="width:100%;"  frameborder="0" onload="this.height=500"></iframe>
					...
					<div class="modal-content">
						...
						<form id="changePasswordForm" class="form-horizontal" role="form">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default"  onclick="logout()" data-dismiss="modal"><fmt:message key="close"/></button>

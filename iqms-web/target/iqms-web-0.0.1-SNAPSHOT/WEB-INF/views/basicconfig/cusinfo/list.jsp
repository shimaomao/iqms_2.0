...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/basicconfig/cusinfo/list.js"></script>
		<script src="${staticPath}/static/js/basicconfig/cusinfo/remove.js"></script>
	...
	<!-- 引入增改查页面 -->
	<%@ include file="/WEB-INF/views/basicconfig/cusinfo/new.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/cusinfo/edit.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/cusinfo/show.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/cusinfo/import.jsp"%>
									...
									<form class="form-search form-inline" id="searchFrom">
										...
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" readonly="readonly" placeholder="请选择机构" value="${currentUser.orgName}" 
										 ...
										 <div class="form-group">
											<label>客户识别码：</label>
											<span class="input-icon">
												<input type="text" placeholder="请输入客户识别码" class="nav-search-input" name="custId" autocomplete="off" />
											</span>
										 </div>
										 ...
										 <div class="form-group">
											<label>客户姓名：</label>
											<span class="input-icon">
												<input type="text" placeholder="请输入客户姓名" class="nav-search-input" name="custName" autocomplete="off" />
											</span>
										 </div>

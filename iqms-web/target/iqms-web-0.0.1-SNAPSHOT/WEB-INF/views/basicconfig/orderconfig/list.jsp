...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/basicconfig/orderconfig/list.js"></script>
		<script src="${staticPath}/static/js/basicconfig/orderconfig/remove.js"></script>
	</head>

	<body class="no-skin">
    	
	<!-- 引入增改查页面 -->
	<%@ include file="/WEB-INF/views/basicconfig/orderconfig/new.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/orderconfig/edit.jsp"%>

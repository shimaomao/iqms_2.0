...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/basicconfig/teller/list.js"></script>
		<script src="${staticPath}/static/js/basicconfig/teller/remove.js"></script>
	</head>
										...
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" readonly="readonly" placeholder="请选择机构" value="${currentUser.orgName}" 
													class="nav-search-input" name="orgName" autocomplete="off" onclick="selectOrgTree(this,true);" />
												<!-- 保存机构id -->
												<input  type="hidden" name="orgId"  value="${currentUser.orgId}"  />
											</span>
											<label>柜员名称：</label>
											<span class="input-icon">
												<input type="text" placeholder="请输入柜员名" class="nav-search-input" name="name_" autocomplete="off" />
											</span>
										 </div>

...
<script src="${staticPath}/static/js/basicconfig/businessmanage/edit.js"></script>
<!--模态窗口页面内容这里是一个表单-->
<div id="dialog-edit" class="hide">
	<form name="FormPost"  class="form-horizontal" onsubmit="return false;" style="width:450px;height:auto;">
		
		<div class="form-group">
			<label class="col-md-4 control-label no-padding-right" for="businessId"> 业务ID  </label>
			<div class="col-md-8">
				<div class="clearfix">
					<input type="text" id="businessId" name="businessId" readonly="readonly" placeholder="请输入字母或数字" class="col-md-8 col-sm-5" />
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-8">
			    <div class="clearfix">
					<input type="text" id="businessName" name="businessName" placeholder="请输入汉字或字母" class="col-md-8 col-sm-5" />
				</div>
			</div>
		</div>
		<div class="form-group">

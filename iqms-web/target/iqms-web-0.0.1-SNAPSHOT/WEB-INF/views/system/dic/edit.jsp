    	...
    	<table  class="easyui-datagrid" style="width:650px;height:250px;" id="dgdbEd" data-options="idField:'dicId',rownumbers:true,singleSelect:true,onClickRow: onClickRowEd">					 
	      <thead>
	        <tr>
	          ...
	          <th data-options="field:'dicValue',width:280,editor:{type:'validatebox',options:{required:true,validType:['name','length[1,64]']}}"><fmt:message key="dic.dicValue" /><span class="required"  style="color:red;">*</span></th>
	          <th data-options="field:'dicSymbol',width:150,editor:{type:'validatebox',options:{required:false,validType:['text','length[1,64]']}}"><fmt:message key="dic.dicSymbol" /></th>
			</tr>
	      </thead>
	    </table>
  </form>

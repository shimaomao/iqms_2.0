...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/report/cometime/list.js"></script>
	...
	<%@ include file="/WEB-INF/views/report/cometime/picture.jsp"%>
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
									...
									<form class="form-search form-inline" id="searchFrom" >
										<div class="form-group">
										  ...
										  <div class="form-group" >
											<label>开始时间：</label>
											<span class="input-icon">
												<input type="text" placeholder="请选择开始时间"  class="nav-search-input" name="startDate" id="startDate" autocomplete="off"/>
											</span>
										 </div>
										  ...
										  <div class="form-group" >
											<label>结束时间：</label>
											<span class="input-icon">
												<input type="text" placeholder="请选择结束时间" class="nav-search-input" name="endDate" id="endDate" autocomplete="off"/>
											</span>
										 </div>
					...
					<!-- 图像报表 -->
					<!-- <div class="row" id="fushioncharts"> 
					<div class="hide" id="fushioncharts">
						<div class="col-md-6 ">

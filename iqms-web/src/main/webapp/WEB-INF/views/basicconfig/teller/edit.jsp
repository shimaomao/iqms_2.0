...
<script src="${staticPath}/static/js/basicconfig/teller/edit.js"></script>
<!--模态窗口页面内容这里是一个表单-->
<div id="dialog-edit" class="hide">
	<form name="FormPost"  class="form-horizontal" onsubmit="return false;" style="width:350px;height:auto;">
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
				<input type="text" id="orgName" name="orgName" placeholder="选中机构" value="" onclick="selectOrgTree(this,true,fillDevNo);" class="col-md-9 col-sm-9" />
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
					<input type="text" id="workId" name="workId" placeholder="请输入工号" class="col-md-9 col-sm-5" readonly="readonly"/>
				</div>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-9">
				<div class="clearfix">
					<select  id="status_edit" name="status" class="col-md-9 col-sm-5">

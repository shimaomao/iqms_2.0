...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/basicconfig/menu/list.js"></script>
		<script src="${staticPath}/static/js/basicconfig/menu/remove.js"></script> 
		<link href="${staticPath}/static/components/ticket/css/bootstrap-11.min.css" rel="stylesheet">
	</head>
	<body class="no-skin">
    	
	<!-- 引入增改查页面 -->
	<%@ include file="/WEB-INF/views/basicconfig/menu/new.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/menu/edit.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/menu/show.jsp"%>
									...
									<form class="form-search form-inline" id="searchFrom">
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" placeholder="请输入菜单名" class="nav-search-input" name="menuName" autocomplete="off" />

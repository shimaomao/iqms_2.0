...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/basicconfig/businessmanage/list.js"></script>
		<script src="${staticPath}/static/js/basicconfig/businessmanage/remove.js"></script>
	...
	<!-- 引入增改查页面 -->
	<%@ include file="/WEB-INF/views/basicconfig/businessmanage/new.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/businessmanage/edit.jsp"%>
	<%@ include file="/WEB-INF/views/basicconfig/businessmanage/show.jsp"%>
									...
									<form class="form-search form-inline" id="searchFrom">
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" placeholder="请输入业务名称" class="nav-search-input" name="businessName" autocomplete="off" />

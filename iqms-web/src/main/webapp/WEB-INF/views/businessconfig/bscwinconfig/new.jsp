...
<script src="${staticPath}/static/js/businessconfig/bscwinconfig/new.js"></script> 
<!--模态窗口页面内容这里是一个表单-->
<div id="dialog-new" class="hide">
	<form name="FormPost"  class="form-horizontal" onsubmit="return false;" style="width:auto;height:auto;">
		...
		<div class="form-group">
			<label class="col-md-3 control-label no-padding-right" for="orgName"> 请选择： </label>
			<div class="col-md-9">
				<div class="clearfix">
				<input type="text" id="devName" name="devName" placeholder="选中机构或设备" value="${currentUser.orgName}" onclick="selectOrgDeviceTree(${currentUser.orgId},true)" class="col-md-9 col-sm-9" />
		...
		<div class="form-group">
			<label class="col-md-3 control-label no-padding-right" for="winNo"> 
			窗口号
			...
			<div class="col-md-9">
				<div class="clearfix">
					<input type="text" id="winNo" name="winNo" placeholder="窗口号"  class="col-md-9 col-sm-5" />
				</div>
			</div>
		</div>

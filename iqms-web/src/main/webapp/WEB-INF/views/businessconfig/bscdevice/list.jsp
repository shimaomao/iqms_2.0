...
<html>
	...
	<head>
		...
		<script src="${staticPath}/static/js/businessconfig/bscdevice/list.js"></script>
		<script src="${staticPath}/static/js/businessconfig/bscdevice/remove.js"></script>
	</head>

	<body class="no-skin">
    	
	<!-- 引入增改查页面 -->
	<%@ include file="/WEB-INF/views/businessconfig/bscdevice/new.jsp"%>
	<%@ include file="/WEB-INF/views/businessconfig/bscdevice/edit.jsp"%>
	<%@ include file="/WEB-INF/views/businessconfig/bscdevice/show.jsp"%>
										...
										<div class="form-group">
											...
											<span class="input-icon">
												<input type="text" readonly="readonly" placeholder="请选择机构" value="${currentUser.orgName}" 
													class="nav-search-input" name="orgName" autocomplete="off" onclick="selectOrgTree(this,true,searchCondition);" />
												<!-- 保存机构id -->

...
<%--   <script src="${staticPath}/static/components/ticket/js/lib/jquery/jquery.js"></script> --%>
  ...
  <script src="${staticPath}/static/components/ticket/js/jquery.ui.draggable.js"></script>
  <script src="${staticPath}/static/components/ticket/js/jquery.ui.sortable.js"></script>
...
<body>
          ...
          <div class="box col-md-12">
            <div class="box-inner">
              <div class="box-header well" data-original-title="">
                <h2>
                  <i class="glyphicon glyphicon-info-sign"></i>取号模板列表
                </h2>
                <div class="box-icon">
              ...
              <div class="box-content">
                 <p class="left">
                  <a class="btn btn-primary" href="#" id="addBtn"><i class="glyphicon glyphicon-plus icon-white"></i>新增模板 </a>
					<a class="btn btn-primary" href="#" id="CopyToOrg"
					onclick="orgDeviceTree(${currentUser.orgId})">
					<i class="glyphicon glyphicon-plus icon-white"></i>应用到下级机构 </a>
					<span class="input-icon"> 
					<!-- 保存机构id -->
	                ...
	                <table style="width: 100%">
	                  <tbody>
	                    <tr>
	                      ...
	                      <td>
	                        <input maxlength='7' validate="{required:true,maxlength:7}" class="form-control" name="styleName" id="styleName" placeholder="请输入模板名称">
	                      </td>
	                    </tr>
	                    <tr>
		                  <td style="text-align: right; width: 20%">
  ...
  <script src="${staticPath}/static/js/businessconfig/takeconfig/list.js" Charset="UTF-8"></script>

...
<sec:authentication property="principal" var="currentUser" />
  <form class="form-grid">
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" data-options="required:true,validType:['name','length[1,32]'],novalidate:true" name="urlName" />
      </div>
      <div class="col-2"></div>
    </div>
     ...
     <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" data-options="required:true,validType:['urlPattern','length[1,32]'],novalidate:true" name="urlPattern" />
      </div>
      <div class="col-2"></div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" data-options="required:false,validType:['actionCode','length[1,32]'],novalidate:true" name="actionCode" />
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control"  data-options="required:false,validType:['actionCode','length[1,32]'],novalidate:true" name="argsCode" />
      </div>
      <div class="col-2"></div>
    </div>

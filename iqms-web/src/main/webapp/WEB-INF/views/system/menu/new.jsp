...
<script type="text/javascript" src="${staticPath}/static/js/system/function/select.js"></script>
  <form class="form-grid">
    ...
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" maxlength="32" data-options="required:false,validType:['menuUrl','length[1,32]'],novalidate:true" name="menuUrl" />
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">
      ...
      <div class="col-1"></div>
      <div class="col-6">
        <input class="easyui-validatebox form-control" maxlength="16" data-options="required:false,validType:['icon','length[1,16]'],novalidate:true" name="icon" />
      </div>
      <div class="col-2"></div>
    </div>
    <div class="form-group">

...
function(e, n, r) {
	"use strict";
	n.module("FileManagerApp", ["pascalprecht.translate", "ngFileUpload"]),
	r(e.document).on("shown.bs.modal", ".modal",
	function() {
		e.setTimeout(function() {
			r("[autofocus]", this).focus()
		}.bind(this), 100)
	}),
	r(e.document).on("click",
	function() {
		r("#context-menu").hide()
	}),
	r(e.document).on("contextmenu", '.main-navigation .table-files tr.item-list:has("td"), .item-list',
	function(n) {
	...
	Array.prototype.find || (Array.prototype.find = function(e) {
		...
		for (var n, r = Object(this), i = r.length >>> 0, a = arguments[1], t = 0; t < i; t++) if (n = r[t], e.call(a, n, t, r)) return n
	})
...
function(e, n) {
	...
	function(e, r, i, a, t, o, s, l) {
		var d = i.localStorage;
		e.config = t,
		e.reverse = !1,
		e.predicate = ["model.type", "model.name"],
		e.order = function(n) {
			e.reverse = e.predicate[1] === n && !e.reverse,
			e.predicate[1] = n
		},
		e.query = "",
		...
		e.openImagePreview = function() {
			...
			e.modal("imagepreview", null, !0).find("#imagepreview-target").attr("src", e.apiMiddleware.getUrl(n)).unbind("load error").on("load error",
			function() {
		...
		e.modalWithPathSelector = function(n) {
			return r.selectedModalPath = e.fileNavigator.currentPath,
			e.modal(n)
		},
		...
		e.copy = function() {
			...
			if (n) {
				...
				if (t && c(n)) return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
				!1;
				if (!i) return e.apiMiddleware.apiHandler.error = a.instant("error_invalid_filename"),
				!1
			}
		...
		e.addForUpload = function(n) {
			e.uploadFileList = e.uploadFileList.concat(n),
			e.modal("uploadfile")
		},
...
function(e) {
	...
	function(e, n, r) {
		...
		e.select = function(r) {
			n.selectedModalPath = r.model.fullPath().split("/"),
			e.modal("selector", !0)
		},
...
function(e) {
	...
	n.directive("ngRightClick", ["$parse",
	function(e) {
	...
	function() {
		var e = function(e) {
			if (this.owner = this.getRwxObj(), this.group = this.getRwxObj(), this.others = this.getRwxObj(), e) {
				...
				this.owner = n.owner,
				this.group = n.group,
				this.others = n.others
			}
		};
		return e.prototype.toOctal = function(e, n) {
			var r = [];
			return ["owner", "group", "others"].forEach(function(e, n) {
				r[n] = this[e].read && this.octalValues.read || 0,
				r[n] += this[e].write && this.octalValues.write || 0,
				r[n] += this[e].exec && this.octalValues.exec || 0
			}.bind(this)),
			(e || "") + r.join("") + (n || "")
		},
		e.prototype.toCode = function(e, n) {
			var r = [];
			return ["owner", "group", "others"].forEach(function(e, n) {
				r[n] = this[e].read && this.codeValues.read || "-",
				r[n] += this[e].write && this.codeValues.write || "-",
				r[n] += this[e].exec && this.codeValues.exec || "-"
			}.bind(this)),
			(e || "") + r.join("") + (n || "")
		},
		...
		e.prototype.convertfromOctal = function(e) {
			if (e = ("" + e).replace(/\s/g, ""), e = 4 === e.length ? e.substr(1) : e, /^[0-7]{3}$/.test(e)) {
				...
				for (var i in r) {
					var a = this.getRwxObj();
					a.read = /[4567]/.test(r[i]),
					a.write = /[2367]/.test(r[i]),
					a.exec = /[1357]/.test(r[i]),
					n.push(a)
				}
				return {
					owner: n[0],
...
function(e, n) {
	"use strict";
	e.module("FileManagerApp").service("apiHandler", ["$http", "$q", "$window", "$translate", "Upload",
	function(e, r, i, a, t) {
		...
		return o.prototype.deferredHandler = function(e, n, r, i) {
			return e && "object" == typeof e || (this.error = "Error %s - Bridge response error, please check the API docs or this ajax response.".replace("%s", r)),
			404 == r && (this.error = "Error 404 - Backend bridge is not working, please check the ajax response."),
			e.result && e.result.error && (this.error = e.result.error),
			!this.error && e.error && (this.error = e.error.message),
			!this.error && i && (this.error = i),
			this.error ? n.reject(e) : n.resolve(e)
		},
		o.prototype.list = function(n, i, a) {
			...
			t.error = "",
			e.post(n, l).success(function(e, n) {
				o(e, s, n)
			}).error(function(e, n) {
		...
		o.prototype.copy = function(n, i, t, o) {
			...
			s.inprocess = !0,
			s.error = "",
			e.post(n, d).success(function(e, n) {
		...
		o.prototype.remove = function(n, i) {
			...
			return t.inprocess = !0,
			t.error = "",
			e.post(n, s).success(function(e, n) {
		...
		o.prototype.changePermissions = function(n, i, t, o, s) {
			...
			l.error = "",
			e.post(n, c).success(function(e, n) {
...
function(e) {
	...
	function(e, n, r) {
		...
		i.prototype.buildTree = function(e) {
			...
			var o = [],
			s = {}; ! this.history.length && this.history.push({

...
//	$.ajax({
//		url : contextPath + "/businessconfig/getcustlevel?dt="
//				+ (new Date().getTime()),
//		type : "get",
//		dataType : "json",
...
function initData2(){
	...
	$tr = $("<tr>" + "<td>"
			...
			+ $rowNum
			+ "' maxlength='3' digits='true' validate='{required:false,digits:true,range:[0,999]}' class=\"form-control\" value = '' placeholder=\"请输入优先时间\"></div></td>"
			...
			+ $rowNum
			+ "'  maxlength='3' digits='true' validate='{required:false,digits:true,range:[0,999]}'  class=\"form-control\" value = '' placeholder=\"请输入最大等候时间\"></div></td>"
...
function initData(itemData) {
	...
	if (itemData) {
		$tr = $("<tr>" + "<td>"
				...
				+ "<td><div class=\"controls\"><input  name='priorTime"
				+ $rowNum
				+ "' maxlength='3' digits='true'  validate='{required:false,digits:true,range:[0,999]}' class=\"form-control\" value = '"
